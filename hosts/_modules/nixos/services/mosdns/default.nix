...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.tmpfiles.rules = [
      ...
      "f /var/lib/mosdns/cache_all.dump 0644 appuser appuser - -"
      "f /var/lib/mosdns/cache_direct.dump 0644 appuser appuser - -"
      "f /var/lib/mosdns/cache_proxy.dump 0644 appuser appuser - -"
      "f /var/lib/mosdns/cache_node.dump 0644 appuser appuser - -"
